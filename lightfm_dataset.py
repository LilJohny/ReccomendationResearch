...
def fetch_movielens(
    ...
    # Load raw data
    try:
        (all_raw,  item_metadata_raw, genres_raw) = _read_raw_data(zip_path)
    ...
    train_length = (1-test_part)*(len(all_raw))
    train_raw, test_raw = all_raw[:train_length], all_raw[train_length:]
